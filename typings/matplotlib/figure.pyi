...
class _AxesStack(cbook.Stack):
    ...
    def bubble(self, a): # -> tuple[Unknown, Unknown] | None:
        """
...
'polar', 'rectilinear', str}, optional
    ...
    def subplots(self, nrows=..., ncols=..., *, sharex=..., sharey=..., squeeze=..., subplot_kw=..., gridspec_kw=...):
        """
    ...
    @docstring.dedent_interpd
    def colorbar(self, mappable, cax=..., ax=..., use_gridspec=..., **kw):
        """%(colorbar_doc)s"""
        ...
    ...
    def subplot_mosaic(self, mosaic, *, sharex=..., sharey=..., subplot_kw=..., gridspec_kw=..., empty_sentinel=...):
        """
...
class Figure(FigureBase):
    ...
    def set_constrained_layout_pads(self, *, w_pad=..., h_pad=..., wspace=..., hspace=...): # -> None:
        """
    ...
    def get_constrained_layout_pads(self, relative=...): # -> tuple[Unknown, Unknown, Unknown, Unknown]:
        """
        Get padding for ``constrained_layout``.
