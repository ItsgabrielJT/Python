...
from pandas._typing import DtypeObj, Ordered, npt, type_t
...
class PeriodDtype(dtypes.PeriodDtypeBase, PandasExtensionDtype):
    ...
    **This is not an actual numpy dtype**, but a duck type.
    ...
    _match = ...
    _cache_dtypes: dict[str_type, PandasExtensionDtype] = ...
    def __new__(cls, freq=...): # -> PandasExtensionDtype | None:
        """
        Parameters
        ----------
        freq : frequency
    ...
    def __reduce__(self): # -> tuple[Type[Self@PeriodDtype], tuple[Unknown]]:
        ...
...
class IntervalDtype(PandasExtensionDtype):
    ...
    **This is not an actual numpy dtype**, but a duck type.
    ...
    _match = ...
    _cache_dtypes: dict[str_type, PandasExtensionDtype] = ...
    def __new__(cls, subtype=..., closed: str_type | None = ...): # -> Self@IntervalDtype | PandasExtensionDtype | None:
        ...
