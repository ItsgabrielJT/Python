...
import contextlib
import numpy as np
from typing import Any, Callable, Collection, Hashable, Iterable, Iterator, Sequence, TYPE_CHECKING, overload
from pandas._typing import AnyArrayLike, ArrayLike, NpDtype, RandomState, Scalar, T
...
def maybe_make_list(obj): # -> list[Unknown] | tuple[Unknown, ...]:
    ...
...
def get_callable_name(obj): # -> Any | None:
    ...
...
def standardize_mapping(into): # -> partial[defaultdict[Unknown, Unknown]] | Type[Mapping[Unknown, Unknown]] | Any:
    """
...
def random_state(state: RandomState | None = ...): # -> RandomState | Generator | Module("numpy.random"):
    """
