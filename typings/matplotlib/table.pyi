...
class Cell(Rectangle):
    ...
    _edges = ...
    _edge_aliases = ...
    def __init__(self, xy, width, height, edgecolor=..., facecolor=..., fill=..., text=..., loc=..., fontproperties=..., *, visible_edges=...) -> None:
        """
        Parameters
        ----------
        xy : 2-tuple
...
@docstring.dedent_interpd
def table(ax, cellText=..., cellColours=..., cellLoc=..., colWidths=..., rowLabels=..., rowColours=..., rowLoc=..., colLabels=..., colColours=..., colLoc=..., loc=..., bbox=..., edges=..., **kwargs):
    """
