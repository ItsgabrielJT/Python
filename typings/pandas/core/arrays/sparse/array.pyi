...
class SparseArray(OpsMixin, PandasObject, ExtensionArray):
    ...
    def nonzero(self): # -> tuple[NDArray[int32]] | tuple[Any]:
        ...
...
def make_sparse(arr: np.ndarray, kind: SparseIndexKind = ..., fill_value=..., dtype: NpDtype | None = ...): # -> tuple[Unknown | ndarray[Any, Unknown] | ndarray[Any, dtype[Any]], IntIndex | BlockIndex, object | Unknown | float | Literal[0, False]]:
    """
