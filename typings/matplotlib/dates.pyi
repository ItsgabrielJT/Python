...
def datestr2num(d, default=...): # -> NDArray[Any] | float:
    """
...
def date2num(d): # -> NDArray[Any] | float:
    """
...
class rrulewrapper:
    ...
    def __getattr__(self, name): # -> Any | ((*args: Unknown, **kwargs: Unknown) -> Unknown):
        ...
...
class DateLocator(ticker.Locator):
    ...
    def nonsingular(self, vmin, vmax): # -> tuple[NDArray[Any] | Unknown | float, NDArray[Any] | Unknown | float] | tuple[Unknown, Unknown]:
        """
...
class RRuleLocator(DateLocator):
    ...
    def __call__(self): # -> NDArray[Any] | float | list[Unknown]:
        ...
    
    def tick_values(self, vmin, vmax): # -> NDArray[Any] | float:
        ...
...
@_api.deprecated("3.5", alternative="`date2num(datetime.utcfromtimestamp(e))<.date2num>`")
def epoch2num(e): # -> Any:
    """
...
class DateConverter(units.ConversionInterface):
    ...
    @staticmethod
    def convert(value, unit, axis): # -> NDArray[Any] | float:
        """
