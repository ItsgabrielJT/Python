...
import textwrap
import numpy as np
from typing import Any, Generic, Hashable, Literal, TYPE_CHECKING, TypeVar, final, overload
from pandas._typing import ArrayLike, DtypeObj, IndexLabel, NDFrameT, NumpySorter, NumpyValueArrayLike, Shape, npt
...
class IndexOpsMixin(OpsMixin):
    ...
    def to_numpy(self, dtype: npt.DTypeLike | None = ..., copy: bool = ..., na_value=..., **kwargs) -> np.ndarray:
        """
    ...
    def tolist(self): # -> list[Unknown] | Any:
        """
    ...
    def isna(self): # -> bool | NDArray[bool_] | ndarray[Unknown, Unknown] | ExtensionArraySupportsAnyAll | Any | NDArray[Any]:
        ...
    ...
    def unique(self): # -> ArrayLike | NDArray[Any]:
        ...
    ...
    @doc(algorithms.factorize, values="", order="", size_hint="", sort=textwrap.dedent("""\
            sort : bool, default False
                ...
                relationship.
            """))
    def factorize(self, sort: bool = ..., na_sentinel: int | None = ...): # -> tuple[ndarray[Unknown, Unknown], ndarray[Unknown, Unknown] | Index]:
        ...
