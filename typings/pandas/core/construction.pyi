...
def extract_array(obj: object, extract_numpy: bool = ..., extract_range: bool = ...) -> Any | ArrayLike:
    """
...
def ensure_wrapped_if_datetimelike(arr): # -> DatetimeArray | TimedeltaArray | ndarray[Unknown, Unknown]:
    """
...
def sanitize_array(data, index: Index | None, dtype: DtypeObj | None = ..., copy: bool = ..., raise_cast_failure: bool = ..., *, allow_2d: bool = ...) -> ArrayLike:
    """
...
def create_series_with_explicit_dtype(data: Any = ..., index: ArrayLike | Index | None = ..., dtype: Dtype | None = ..., name: str | None = ..., copy: bool = ..., fastpath: bool = ..., dtype_if_empty: Dtype = ...) -> Series:
    """
