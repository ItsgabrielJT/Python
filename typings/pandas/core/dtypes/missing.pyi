...
_dtype_object = ...
_dtype_str = ...
def isna(obj): # -> bool | NDArray[bool_] | ndarray[Unknown, Unknown] | ExtensionArraySupportsAnyAll | Any | NDArray[Any]:
    """
...
isnull = ...
def notna(obj): # -> bool | int | NDArray[bool_] | Any:
    """
...
def infer_fill_value(val): # -> NDArray[Unknown] | float:
    """
...
def na_value_for_dtype(dtype: DtypeObj, compat: bool = ...): # -> object | float | Literal[0, False]:
    """
