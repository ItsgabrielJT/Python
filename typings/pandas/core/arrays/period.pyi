...
class PeriodArray(dtl.DatelikeOps):
    ...
    def astype(self, dtype, copy: bool = ...): # -> Self@PeriodArray | PeriodArray | DatetimeArray | ndarray[Any, dtype[object_]] | ndarray[Any, Unknown] | ExtensionArray | NDArray[Any] | NDArray[int64] | NDArray[Unknown]:
        ...
...
def period_array(data: Sequence[Period | str | None] | AnyArrayLike, freq: str | Tick | None = ..., copy: bool = ...) -> PeriodArray:
    """
...
def dt64arr_to_periodarr(data, freq, tz=...): # -> tuple[NDArray[int64], Unknown]:
    """
