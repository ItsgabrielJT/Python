...
import numpy as np
from . import _api, artist, cbook, cm, docstring
...
line segments).
"""
@cbook._define_aliases({ "antialiased": ["antialiaseds", "aa"],"edgecolor": ["edgecolors", "ec"],"facecolor": ["facecolors", "fc"],"linestyle": ["linestyles", "dashes", "ls"],"linewidth": ["linewidths", "lw"] })
class Collection(artist.Artist, cm.ScalarMappable):
    ...
    _edge_default = ...
    @docstring.interpd
    def __init__(self, edgecolors=..., facecolors=..., linewidths=..., linestyles=..., capstyle=..., joinstyle=..., antialiaseds=..., offsets=..., transOffset=..., norm=..., cmap=..., pickradius=..., hatch=..., urls=..., *, zorder=..., **kwargs) -> None:
        """
        Parameters
        ----------
    ...
    def contains(self, mouseevent): # -> tuple[Literal[False], dict[Unknown, Unknown]] | tuple[bool, dict[str, Unknown]]:
        """
    ...
    def get_linewidth(self): # -> list[int] | NDArray[Unknown] | list[Unknown]:
        ...
    
    def get_linestyle(self): # -> list[tuple[Literal[0], None]] | list[tuple[Unknown | int, tuple[Unknown, ...] | Unknown | None]] | list[tuple[Unknown, Unknown] | tuple[Unknown, list[Unknown | None] | None]]:
        ...
...
class _CollectionWithSizes(Collection):
    ...
    """
    _factor = ...
    def get_sizes(self): # -> NDArray[Any] | NDArray[Unknown]:
        """
...
class PathCollection(_CollectionWithSizes):
    ...
    def legend_elements(self, prop=..., num=..., fmt=..., func=..., **kwargs):
        """
...
class BrokenBarHCollection(PolyCollection):
    ...
    *xranges*.
    ...
    @classmethod
    def span_where(cls, x, ymin, ymax, where, **kwargs): # -> Self@BrokenBarHCollection:
        """
...
class LineCollection(Collection):
    ...
    """
    _edge_default = ...
    def __init__(self, segments, *args, zorder=..., **kwargs) -> None:
        """
        Parameters
        ----------
...
class EventCollection(LineCollection):
    ...
    """
    _edge_default = ...
    def __init__(self, positions, orientation=..., lineoffset=..., linelength=..., linewidth=..., color=..., linestyle=..., antialiased=..., **kwargs) -> None:
        """
        Parameters
        ----------
    ...
    def get_linelength(self): # -> Unknown:
    ...
    def get_lineoffset(self): # -> Unknown:
    ...
    def get_linewidth(self): # -> int | Any:
        """Get the width of the lines used to mark each event."""
        ...
    
    def get_linewidths(self): # -> list[int] | NDArray[Unknown] | list[Unknown]:
        ...
...
class QuadMesh(Collection):
    ...
    def get_coordinates(self): # -> ndarray[Any, dtype[float64]]:
        """
    ...
    @staticmethod
    @_api.deprecated("3.5", alternative="`QuadMesh(coordinates).get_paths()" "<.QuadMesh.get_paths>`")
    def convert_mesh_to_paths(meshWidth, meshHeight, coordinates): # -> list[Path]:
        ...
    
    @_api.deprecated("3.5")
    def convert_mesh_to_triangles(self, meshWidth, meshHeight, coordinates): # -> tuple[ndarray[Any, dtype[Any | Unknown]], ndarray[Any, dtype[Unknown]]]:
        ...
