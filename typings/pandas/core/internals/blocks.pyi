...
import numpy as np
from typing import Any, Callable, Iterable, Sequence, TYPE_CHECKING, final
...
class Block(PandasObject):
    ...
    @final
    @cache_readonly
    def fill_value(self): # -> object | float | Literal[0, False]:
        ...
    ...
    @final
    def make_block_same_class(self, values, placement: BlockPlacement | None = ...) -> Block:
    ...
    def iget(self, i: int | tuple[int, int] | tuple[slice, int]): # -> ndarray[Any, Unknown]:
        ...
    ...
    @final
    def astype(self, dtype: DtypeObj, copy: bool = ..., errors: str = ...): # -> Block:
        """
    ...
    @final
    def copy(self, deep: bool = ...): # -> Self@Block:
        """copy constructor"""
        ...
    
    @final
    def replace(self, to_replace, value, inplace: bool = ..., mask: npt.NDArray[np.bool_] | None = ...) -> list[Block]:
        """
    ...
    def interpolate(self, method: str = ..., axis: int = ..., index: Index | None = ..., inplace: bool = ..., limit: int | None = ..., limit_direction: str = ..., limit_area: str | None = ..., fill_value: Any | None = ..., coerce: bool = ..., downcast: str | None = ..., **kwargs) -> list[Block]:
        ...
    
    def take_nd(self, indexer, axis: int, new_mgr_locs: BlockPlacement | None = ..., fill_value=...) -> Block:
        """
...
class EABackedBlock(Block):
    ...
    def interpolate(self, method=..., axis=..., inplace=..., limit=..., fill_value=..., **kwargs): # -> Block:
        ...
...
class NDArrayBackedExtensionBlock(libinternals.NDArrayBackedBlock, EABackedBlock):
    ...
    def setitem(self, indexer, value): # -> Self@NDArrayBackedExtensionBlock:
        ...
...
def get_block_type(dtype: DtypeObj): # -> Type[ExtensionBlock] | Type[CategoricalBlock] | Type[DatetimeTZBlock] | Type[NDArrayBackedExtensionBlock] | Type[DatetimeLikeBlock] | Type[NumericBlock] | Type[ObjectBlock]:
    """
...
def new_block_2d(values: ArrayLike, placement: BlockPlacement): # -> ExtensionBlock | CategoricalBlock | DatetimeTZBlock | NDArrayBackedExtensionBlock | DatetimeLikeBlock | NumericBlock | ObjectBlock:
    ...
...
def to_native_types(values: ArrayLike, *, na_rep=..., quoting=..., float_format=..., decimal=..., **kwargs) -> np.ndarray:
    """convert to our native types format"""
    ...
