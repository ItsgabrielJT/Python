...
_fill_methods = ...
def get_fill_func(method, ndim: int = ...): # -> (values: ndarray[Unknown, Unknown], limit: int | None = None, mask: NDArray[bool_] | None = None) -> tuple[ndarray[Unknown, Unknown], NDArray[bool_]]:
    ...
