...
"""
@docstring.interpd
@cbook._define_aliases({ "antialiased": ["aa"],"edgecolor": ["ec"],"facecolor": ["fc"],"linestyle": ["ls"],"linewidth": ["lw"] })
...
class StepPatch(PathPatch):
    ...
    def set_data(self, values=..., edges=..., baseline=...):
        """
...
class Polygon(Patch):
    ...
    def get_closed(self): # -> Unknown | bool:
...
class FancyArrow(Polygon):
    ...
    def set_data(self, *, x=..., y=..., dx=..., dy=..., width=..., head_width=..., head_length=...):
        """
...
class ArrowStyle(_Style):
    ...
    class _Base:
        ...
        def __call__(self, path, mutation_size, linewidth, aspect_ratio=...): # -> tuple[list[Unknown], Iterable[Any]] | tuple[Unknown, Unknown]:
            """
...
class FancyBboxPatch(Patch):
    ...
    def __init__(self, xy, width, height, boxstyle=..., bbox_transmuter=..., mutation_scale=..., mutation_aspect=..., **kwargs) -> None:
        """
        Parameters
        ----------
        xy : float, float
    ...
    def get_mutation_scale(self): # -> Unknown:
    ...
    def get_mutation_aspect(self): # -> Literal[1]:
        """Return the aspect ratio of the bbox mutation."""
        ...
    
    def get_boxstyle(self): # -> _Base | BoxStyle:
...
class FancyArrowPatch(Patch):
    ...
    def __init__(self, posA=..., posB=..., path=..., arrowstyle=..., connectionstyle=..., patchA=..., patchB=..., shrinkA=..., shrinkB=..., mutation_scale=..., mutation_aspect=..., dpi_cor=..., **kwargs) -> None:
        """
...
default: 'arc3'
    ...
    def set_connectionstyle(self, connectionstyle, **kw): # -> str | None:
        """
    ...
    def get_connectionstyle(self): # -> _Base | ConnectionStyle:
        """Return the `ConnectionStyle` used."""
        ...
    
    def set_arrowstyle(self, arrowstyle=..., **kw): # -> str | None:
        """
    ...
    def get_arrowstyle(self): # -> _Base | ArrowStyle:
    ...
    def get_path(self): # -> Path | list[Unknown]:
...
class ConnectionPatch(FancyArrowPatch):
    ...
    @docstring.dedent_interpd
    @_api.delete_parameter("3.4", "dpi_cor")
    def __init__(self, xyA, xyB, coordsA, coordsB=..., axesA=..., axesB=..., arrowstyle=..., connectionstyle=..., patchA=..., patchB=..., shrinkA=..., shrinkB=..., mutation_scale=..., mutation_aspect=..., clip_on=..., dpi_cor=..., **kwargs) -> None:
        """
