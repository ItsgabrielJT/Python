...
if TYPE_CHECKING:
    ...
def get_indexer_indexer(target: Index, level: str | int | list[str] | list[int], ascending: Sequence[bool | int] | bool | int, kind: str, na_position: str, sort_remaining: bool, key: IndexKeyFunc) -> np.ndarray | None:
    """
...
def decons_group_index(comp_labels, shape): # -> list[Unknown]:
    ...

def decons_obs_group_ids(comp_ids: npt.NDArray[np.intp], obs_ids, shape, labels, xnull: bool): # -> list[Unknown]:
    """
...
def lexsort_indexer(keys, orders=..., na_position: str = ..., key: Callable | None = ...) -> npt.NDArray[np.intp]:
    """
...
def nargsort(items, kind: str = ..., ascending: bool = ..., na_position: str = ..., key: Callable | None = ..., mask: np.ndarray | None = ...) -> npt.NDArray[np.intp]:
    """
...
def nargminmax(values, method: str, axis: int = ...): # -> NDArray[Any] | Any | int:
    """
...
def ensure_key_mapped(values, key: Callable | None, levels=...): # -> MultiIndex | Index | Any:
    """
