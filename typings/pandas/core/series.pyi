...
from pandas._typing import AggFuncType, ArrayLike, Axis, Dtype, DtypeObj, FillnaOptions, IndexKeyFunc, NumpySorter, NumpyValueArrayLike, SingleManager, StorageOptions, TimedeltaConvertibleTypes, TimestampConvertibleTypes, ValueKeyFunc, npt
...
class Series(base.IndexOpsMixin, NDFrame):
    ...
    def __init__(self, data=..., index=..., dtype: Dtype | None = ..., name=..., copy: bool = ..., fastpath: bool = ...) -> None:
        ...
    ...
    def ravel(self, order=...): # -> ExtensionArray | ndarray[Any, Unknown]:
        """
    ...
    def to_string(self, buf=..., na_rep=..., float_format=..., header=..., index=..., length=..., dtype=..., name=..., max_rows=..., min_rows=...): # -> str | None:
        """
    ...
    @doc(klass=_shared_doc_kwargs["klass"], storage_options=_shared_docs["storage_options"], examples=dedent("""Examples
            ...
            |  3 | quetzal  |
            +----+----------+"""))
    def to_markdown(self, buf: IO[str] | None = ..., mode: str = ..., index: bool = ..., storage_options: StorageOptions = ..., **kwargs) -> str | None:
        """
    ...
    def to_dict(self, into=...): # -> defaultdict[Unknown, Unknown] | Mapping[Unknown, Unknown] | Any:
        """
...
""")
    ...
    def groupby(self, by=..., axis=..., level=..., as_index: bool = ..., sort: bool = ..., group_keys: bool = ..., squeeze: bool | lib.NoDefault = ..., observed: bool = ..., dropna: bool = ...) -> SeriesGroupBy:
        ...
    ...
    def idxmin(self, axis=..., skipna=..., *args, **kwargs): # -> float:
        """
    ...
    def idxmax(self, axis=..., skipna=..., *args, **kwargs): # -> float:
        """
    ...
    def __matmul__(self, other): # -> Series | Any:
        """
        Matrix multiplication using binary `@` operator in Python>=3.5.
        """
        ...
    
    def __rmatmul__(self, other): # -> Series | Any:
        """
        Matrix multiplication using binary `@` operator in Python>=3.5.
        """
        ...
...
""", klass=_shared_doc_kwargs["klass"])
    def compare(self, other: Series, align_axis: Axis = ..., keep_shape: bool = ..., keep_equal: bool = ...) -> DataFrame | Series:
        ...
    ...
    @deprecate_nonkeyword_arguments(version=None, allowed_args=["self"])
    def sort_values(self, axis=..., ascending: bool | int | Sequence[bool | int] = ..., inplace: bool = ..., kind: str = ..., na_position: str = ..., ignore_index: bool = ..., key: ValueKeyFunc = ...): # -> Series | None:
        """
        Sort by the values.
    ...
    @deprecate_nonkeyword_arguments(version=None, allowed_args=["self"])
    def sort_index(self, axis=..., level=..., ascending: bool | int | Sequence[bool | int] = ..., inplace: bool = ..., kind: str = ..., na_position: str = ..., sort_remaining: bool = ..., ignore_index: bool = ..., key: IndexKeyFunc = ...): # -> Series | None:
        """
    ...
    @doc(klass=_shared_doc_kwargs["klass"], extra_params=dedent("""copy : bool, default True
            Whether to copy underlying data."""), examples=dedent("""\
        Examples
        --------
        >>> s = pd.Series(
        ...     ["A", "B", "A", "C"],
    ...
    def aggregate(self, func=..., axis=..., *args, **kwargs): # -> DataFrame | Series:
        ...
    ...
    def apply(self, func: AggFuncType, convert_dtype: bool = ..., args: tuple[Any, ...] = ..., **kwargs) -> DataFrame | Series:
        """
    ...
    def rename(self, index=..., *, axis=..., copy=..., inplace=..., level=..., errors=...) -> Series | None:
        """
    ...
    @deprecate_nonkeyword_arguments(version=None, allowed_args=["self", "labels"])
    def drop(self, labels=..., axis=..., index=..., columns=..., level=..., inplace=..., errors=...) -> Series:
        """
    ...
    @overload
    def fillna(self, value=..., method: FillnaOptions | None = ..., axis: Axis | None = ..., inplace: Literal[False] = ..., limit=..., downcast=...) -> Series:
        ...
    ...
    @overload
    def fillna(self, value=..., method: FillnaOptions | None = ..., axis: Axis | None = ..., inplace: bool = ..., limit=..., downcast=...) -> Series | None:
        ...
    
    @deprecate_nonkeyword_arguments(version=None, allowed_args=["self", "value"])
    @doc(NDFrame.fillna, **_shared_doc_kwargs)
    def fillna(self, value: object | ArrayLike | None = ..., method: FillnaOptions | None = ..., axis=..., inplace=..., limit=..., downcast=...) -> Series | None:
        ...
    ...
    def replace(self, to_replace=..., value=..., inplace=..., limit=..., regex=..., method: str | lib.NoDefault = ...): # -> Any | Series | None:
        ...
    ...
    def asfreq(self, freq, method=..., how: str | None = ..., normalize: bool = ..., fill_value=...) -> Series:
        ...
    ...
    @deprecate_nonkeyword_arguments(version=None, allowed_args=["self"])
    def ffill(self: Series, axis: None | Axis = ..., inplace: bool = ..., limit: None | int = ..., downcast=...) -> Series | None:
        ...
    
    @deprecate_nonkeyword_arguments(version=None, allowed_args=["self"])
    def bfill(self: Series, axis: None | Axis = ..., inplace: bool = ..., limit: None | int = ..., downcast=...) -> Series | None:
        ...
    
    @deprecate_nonkeyword_arguments(version=None, allowed_args=["self", "lower", "upper"])
    def clip(self: Series, lower=..., upper=..., axis: Axis | None = ..., inplace: bool = ..., *args, **kwargs) -> Series | None:
        ...
    
    @deprecate_nonkeyword_arguments(version=None, allowed_args=["self", "method"])
    def interpolate(self: Series, method: str = ..., axis: Axis = ..., limit: int | None = ..., inplace: bool = ..., limit_direction: str | None = ..., limit_area: str | None = ..., downcast: str | None = ..., **kwargs) -> Series | None:
        ...
