...
from matplotlib import _api, backend_tools as tools, docstring
...
class RendererBase:
    ...
    * :meth:`draw_quad_mesh`
    ...
    def draw_quad_mesh(self, gc, master_transform, meshWidth, meshHeight, coordinates, offsets, offsetTrans, facecolors, antialiased, edgecolors): # -> None:
        """
...
'scroll_event', 'motion_notify_event').
    ...
    """
    def __init__(self, name, canvas, x, y, button=..., key=..., step=..., dblclick=..., guiEvent=...) -> None:
        ...
...
class PickEvent(Event):
    ...
    """
    def __init__(self, name, canvas, mouseevent, artist, guiEvent=..., **kwargs) -> None:
        ...
...
class FigureCanvasBase:
    ...
    def inaxes(self, xy): # -> SupportsRichComparisonT@max | None:
        """
    ...
    def print_figure(self, filename, dpi=..., facecolor=..., edgecolor=..., orientation=..., format=..., *, bbox_inches=..., pad_inches=..., bbox_extra_artists=..., backend=..., **kwargs):
        """
    ...
    @_api.deprecated("3.4", alternative="`.FigureManagerBase.get_window_title`" " or GUI-specific methods")
    ...
    @_api.deprecated("3.4", alternative="`.FigureManagerBase.set_window_title`" " or GUI-specific methods")
...
class FigureManagerBase:
    ...
    **Other operations**
    ...
    @_api.deprecated("3.4", alternative="self.canvas.callbacks.process(event.name, event)")
...
class _Backend:
    ...
    mainloop = ...
    @classmethod
    def new_figure_manager(cls, num, *args, **kwargs): # -> FigureManager:
        """Create a new figure manager instance."""
        ...
    
    @classmethod
    def new_figure_manager_given_figure(cls, num, figure): # -> FigureManager:
