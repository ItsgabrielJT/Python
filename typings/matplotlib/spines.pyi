...
class Spine(mpatches.Patch):
    ...
    def get_spine_transform(self): # -> BlendedAffine2D | BlendedGenericTransform | None:
    ...
    @classmethod
    def arc_spine(cls, axes, spine_type, center, radius, theta1, theta2, **kwargs): # -> Self@Spine:
