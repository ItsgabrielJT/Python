...
class GeoAxes(Axes):
    ...
    def get_xaxis_text1_transform(self, pad): # -> tuple[Unknown, Literal['bottom'], Literal['center']]:
        ...
    
    def get_xaxis_text2_transform(self, pad): # -> tuple[Unknown, Literal['top'], Literal['center']]:
        ...
    
    def get_yaxis_transform(self, which=...):
        ...
    
    def get_yaxis_text1_transform(self, pad): # -> tuple[Unknown, Literal['center'], Literal['right']]:
        ...
    
    def get_yaxis_text2_transform(self, pad): # -> tuple[Unknown, Literal['center'], Literal['left']]:
        ...
