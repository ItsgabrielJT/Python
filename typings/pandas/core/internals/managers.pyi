...
class BaseBlockManager(DataManager):
    ...
    def get_dtypes(self): # -> ndarray[Any, dtype[Any]]:
        ...
    ...
    def putmask(self, mask, new, align: bool = ...): # -> Self@BaseBlockManager:
        ...
    ...
    def convert(self: T, copy: bool = ..., datetime: bool = ..., numeric: bool = ..., timedelta: bool = ...) -> T:
        ...
    
    def replace(self: T, to_replace, value, inplace: bool) -> T:
        ...
    
    def replace_regex(self, **kwargs): # -> Self@BaseBlockManager:
        ...
    
    def replace_list(self: T, src_list: list[Any], dest_list: list[Any], inplace: bool = ..., regex: bool = ...) -> T:
        """do a list replace"""
        ...
    ...
    def reindex_indexer(self: T, new_axis: Index, indexer, axis: int, fill_value=..., allow_dups: bool = ..., copy: bool = ..., consolidate: bool = ..., only_slice: bool = ..., *, use_na_proxy: bool = ...) -> T:
        """
        Parameters
        ----------
        new_axis : Index
...
class BlockManager(libinternals.BlockManager, BaseBlockManager):
    ...
    def iset(self, loc: int | slice | np.ndarray, value: ArrayLike, inplace: bool = ...): # -> None:
        """
    ...
    def reduce(self: T, func: Callable, ignore_failures: bool = ...) -> tuple[T, np.ndarray]:
        """
    ...
    def as_array(self, dtype: np.dtype | None = ..., copy: bool = ..., na_value=...) -> np.ndarray:
        """
...
class SingleBlockManager(BaseBlockManager, SingleDataManager):
    ...
    __slots__ = ...
    is_single_block = ...
    def __init__(self, block: Block, axis: Index, verify_integrity: bool = ..., fastpath=...) -> None:
        ...
    ...
    def __getstate__(self): # -> tuple[list[Index], list[ndarray[Unknown, Unknown] | ExtensionArray], list[Unknown], dict[str, dict[str, Unknown]]]:
        ...
    ...
    def internal_values(self): # -> ndarray[Unknown, Unknown] | ExtensionArray:
    ...
    def get_numeric_data(self, copy: bool = ...): # -> Self@SingleBlockManager:
        ...
...
def construction_error(tot_items: int, block_shape: Shape, axes: list[Index], e: ValueError | None = ...): # -> ValueError:
