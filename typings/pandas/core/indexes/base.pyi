...
import numpy as np
from typing import Any, Callable, Hashable, Literal, Sequence, TYPE_CHECKING, TypeVar, final
from pandas._libs import index as libindex
from pandas._typing import AnyArrayLike, ArrayLike, Dtype, DtypeObj, Shape, npt
...
class Index(IndexOpsMixin, PandasObject):
    ...
    _accessors = ...
    str = ...
    def __new__(cls, data=..., dtype=..., copy=..., name=..., tupleize_cols=..., **kwargs) -> Index:
        ...
    ...
    def __array_ufunc__(self, ufunc: np.ufunc, method: str_t, *inputs, **kwargs): # -> _NotImplementedType | tuple[Unknown, ...] | Any | tuple[object | Index, ...] | object | Index:
        ...
    ...
    @final
    def ravel(self, order=...): # -> ndarray[Any, dtype[Any]] | ndarray[Any, Unknown]:
        """
    ...
    def astype(self, dtype, copy: bool = ...): # -> Self@Index | Index:
        """
    ...
    def take(self, indices, axis: int = ..., allow_fill: bool = ..., fill_value=..., **kwargs): # -> Self@Index:
        ...
    
    @Appender(_index_shared_docs["repeat"] % _index_doc_kwargs)
    def repeat(self, repeats, axis=...): # -> Self@Index:
        ...
    
    def copy(self: _IndexT, name: Hashable | None = ..., deep: bool = ..., dtype: Dtype | None = ..., names: Sequence[Hashable] | None = ...) -> _IndexT:
        """
    ...
    def set_names(self, names, level=..., inplace: bool = ...): # -> Self@Index | None:
        """
    ...
    def rename(self, name, inplace=...): # -> Self@Index | None:
        """
    ...
    def sortlevel(self, level=..., ascending=..., sort_remaining=...): # -> tuple[Self@Index, NDArray[intp] | Unknown | Any] | Self@Index:
        """
    ...
    def __reduce__(self): # -> tuple[(cls: Unknown, d: Unknown) -> Unknown, tuple[Type[Self@Index], dict[str, Unknown]], None]:
        ...
    ...
    @final
    def difference(self, other, sort=...): # -> Self@Index | Index | None:
        """
    ...
    @final
    def get_indexer(self, target, method: str_t | None = ..., limit: int | None = ..., tolerance=...) -> npt.NDArray[np.intp]:
        ...
    
    def reindex(self, target, method=..., level=..., limit=..., tolerance=...) -> tuple[Index, npt.NDArray[np.intp] | None]:
        """
    ...
    def join(self, other, how: str_t = ..., level=..., return_indexers: bool = ..., sort: bool = ...): # -> tuple[MultiIndex, Unknown, Unknown] | tuple[MultiIndex, NDArray[intp] | None, NDArray[intp] | None] | tuple[Self@Index, None, NDArray[intp]] | tuple[Index, NDArray[intp], None] | tuple[Unknown, Unknown, Unknown] | tuple[Index, NDArray[intp], NDArray[intp]] | tuple[Index, NDArray[intp] | None, NDArray[intp] | None]:
        """
    ...
    @final
    def asof(self, label): # -> NaTType | float | object:
        """
    ...
    def sort_values(self, return_indexer: bool = ..., ascending: bool = ..., na_position: str_t = ..., key: Callable | None = ...): # -> tuple[Self@Index, NDArray[intp] | Unknown | Any] | Self@Index:
        """
    ...
    def slice_indexer(self, start: Hashable | None = ..., end: Hashable | None = ..., step: int | None = ..., kind=...) -> slice:
        """
