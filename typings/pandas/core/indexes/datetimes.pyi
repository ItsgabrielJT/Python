...
from typing import Hashable, Literal, TYPE_CHECKING
...
@inherit_names(["tz", "tzinfo", "dtype", "to_pydatetime", "_format_native_types", "date", "time", "timetz", "std"] + DatetimeArray._bool_ops, DatetimeArray)
class DatetimeIndex(DatetimeTimedeltaMixin):
    ...
    def __new__(cls, data=..., freq=..., tz=..., normalize: bool = ..., closed=..., ambiguous=..., dayfirst: bool = ..., yearfirst: bool = ..., dtype: Dtype | None = ..., copy: bool = ..., name: Hashable = ...) -> DatetimeIndex:
        ...
    
    def __reduce__(self): # -> tuple[(cls: Unknown, d: Unknown) -> Unknown, tuple[Type[Self@DatetimeIndex], dict[str, Unknown]], None]:
        ...
...
def date_range(start=..., end=..., periods=..., freq=..., tz=..., normalize: bool = ..., name: Hashable = ..., closed: str | None | lib.NoDefault = ..., inclusive: str | None = ..., **kwargs) -> DatetimeIndex:
    """
...
def bdate_range(start=..., end=..., periods: int | None = ..., freq=..., tz=..., normalize: bool = ..., name: Hashable = ..., weekmask=..., holidays=..., closed: lib.NoDefault = ..., inclusive: str | None = ..., **kwargs) -> DatetimeIndex:
    """
