...
class TickHelper:
    ...
    @_api.deprecated("3.5", alternative="`.Axis.set_view_interval` and `.Axis.set_data_interval`")
...
class IndexLocator(Locator):
    ...
    def __call__(self): # -> NDArray[signedinteger[Any]]:
        """Return the locations of the ticks"""
        ...
    
    def tick_values(self, vmin, vmax): # -> NDArray[signedinteger[Any]]:
        ...
...
class LinearLocator(Locator):
    ...
    def __call__(self): # -> NDArray[floating[Any]] | list[Unknown]:
        """Return the locations of the ticks."""
        ...
    
    def tick_values(self, vmin, vmax): # -> NDArray[floating[Any]] | list[Unknown]:
        ...
...
class MaxNLocator(Locator):
    ...
    def view_limits(self, dmin, dmax): # -> tuple[Unknown, Unknown]:
        ...
    


def is_decade(x, base=..., *, rtol=...): # -> bool:
    ...
...
class LogLocator(Locator):
    ...
    def view_limits(self, vmin, vmax): # -> tuple[float | Unknown | Any, Unknown | Any | int]:
        """Try to choose the view limits intelligently."""
        ...
