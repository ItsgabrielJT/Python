...
class _Unstacker:
    ...
    @cache_readonly
    def sorted_labels(self): # -> list[ndarray[Any, Unknown]]:
        ...
...
def get_dummies(data, prefix=..., prefix_sep=..., dummy_na: bool = ..., columns=..., sparse: bool = ..., drop_first: bool = ..., dtype: Dtype | None = ...) -> DataFrame:
    """
