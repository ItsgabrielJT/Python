...
class Path:
    ...
    def __init__(self, vertices, codes=..., _interpolation_steps=..., closed=..., readonly=...) -> None:
        """
    ...
    @property
    def codes(self): # -> NDArray[code_type]:
        """
    ...
    @property
    def should_simplify(self): # -> bool_ | bool:
        """
    ...
    def __deepcopy__(self, memo=...): # -> Self@Path:
        """
    ...
    def iter_segments(self, transform=..., remove_nans=..., clip=..., snap=..., stroke_width=..., simplify=..., curves=..., sketch=...): # -> Generator[tuple[Any | NDArray[Any], Any], None, None]:
        """
    ...
    def cleaned(self, transform=..., remove_nans=..., clip=..., *, simplify=..., curves=..., stroke_width=..., snap=..., sketch=...): # -> Path:
        """
    ...
    def to_polygons(self, transform=..., width=..., height=..., closed_only=...):
        """
    ...
    @classmethod
    def arc(cls, theta1, theta2, n=..., is_wedge=...):
        """
...
def get_path_collection_extents(master_transform, paths, transforms, offsets, offset_transform): # -> Bbox:
    r"""
