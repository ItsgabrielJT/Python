...
from pandas._typing import AnyArrayLike, ArrayLike
...
def maybe_convert_indices(indices, n: int, verify: bool = ...): # -> NDArray[intp] | NDArray[Unknown]:
    """
...
def unpack_tuple_and_ellipses(item: tuple): # -> tuple[Unknown, ...]:
    """
