...
class Term(ops.Term):
    env: PyTablesScope
    def __new__(cls, name, env, side=..., encoding=...): # -> Self@Term | Constant:
        ...
...
class BinOp(ops.BinOp):
    ...
    def conform(self, rhs): # -> ndarray[Any, Unknown] | list[Unknown]:
        """inplace conform rhs"""
        ...
...
class FilterBinOp(BinOp):
    ...
    def evaluate(self): # -> Self@FilterBinOp | None:
        ...
    
    def generate_filter_op(self, invert: bool = ...): # -> (axis: Unknown, vals: Unknown) -> Unknown:
        ...
...
class JointFilterBinOp(FilterBinOp):
    ...
    def evaluate(self): # -> Self@JointFilterBinOp:
        ...
...
class ConditionBinOp(BinOp):
    ...
    def evaluate(self): # -> Self@ConditionBinOp | None:
        ...
    


class JointConditionBinOp(ConditionBinOp):
    def evaluate(self): # -> Self@JointConditionBinOp:
        ...
...
class PyTablesExprVisitor(BaseExprVisitor):
    ...
    def visit_UnaryOp(self, node, **kwargs): # -> UnaryOp | Term | None:
        ...
...
class PyTablesExpr(expr.Expr):
    ...
    def evaluate(self): # -> tuple[Unknown, Unknown]:
