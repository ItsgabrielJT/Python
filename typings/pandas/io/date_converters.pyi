...
def parse_date_time(date_col, time_col): # -> NDArray[object_]:
    """
...
def parse_date_fields(year_col, month_col, day_col): # -> NDArray[object_]:
    """
...
def parse_all_fields(year_col, month_col, day_col, hour_col, minute_col, second_col): # -> NDArray[object_]:
    """
...
def generic_parser(parse_func, *cols): # -> NDArray[Any]:
    """
