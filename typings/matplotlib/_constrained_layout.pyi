...
"""
_log = ...
def do_constrained_layout(fig, renderer, h_pad, w_pad, hspace=..., wspace=...): # -> dict[Unknown, Unknown] | None:
    """
...
def make_layoutgrids(fig, layoutgrids): # -> dict[Unknown, Unknown]:
    """
...
def reposition_colorbar(layoutgrids, cbax, renderer, *, offset=...):
    """
