...
class AbstractMovieWriter(abc.ABC):
    ...
    def saving(self, fig, outfile, dpi, *args, **kwargs): # -> Generator[Self@AbstractMovieWriter, None, None]:
        """
...
class FuncAnimation(TimedAnimation):
    ...
    def new_frame_seq(self): # -> count[int] | Generator[Any, None, None] | Iterator[Any] | Iterator[int]:
        ...
    
    def new_saved_frame_seq(self): # -> Iterator[Unknown] | islice[int] | Generator[int, None, None]:
        ...
