...
class _LocationIndexer(NDFrameIndexerBase):
    _valid_types: str
    axis = ...
    def __call__(self, axis=...): # -> Self@_LocationIndexer:
        ...
...
def convert_missing_indexer(indexer): # -> tuple[Unknown, Literal[True]] | tuple[Unknown, Literal[False]]:
    """
...
def maybe_convert_ix(*args): # -> tuple[Unknown, ...] | tuple[ndarray[Any, Unknown], ...]:
    """
