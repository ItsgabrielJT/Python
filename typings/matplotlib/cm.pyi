...
def get_cmap(name=..., lut=...): # -> Colormap | ListedColormap:
    """
...
def unregister_cmap(name): # -> ListedColormap | None:
    """
...
class ScalarMappable:
    ...
    def get_cmap(self): # -> Colormap | ListedColormap | None:
        """Return the `.Colormap` instance."""
        ...
    
    def get_clim(self): # -> tuple[Unknown | float, Unknown | float]:
        """
