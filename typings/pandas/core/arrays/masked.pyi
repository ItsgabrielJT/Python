...
class BaseMaskedArray(OpsMixin, ExtensionArray):
    ...
    def sum(self, *, skipna=..., min_count=..., axis: int | None = ..., **kwargs): # -> FloatingArray | BooleanArray | TimedeltaArray | IntegerArray | NAType:
        ...
    
    def prod(self, *, skipna=..., min_count=..., axis: int | None = ..., **kwargs): # -> FloatingArray | BooleanArray | TimedeltaArray | IntegerArray | NAType:
        ...
