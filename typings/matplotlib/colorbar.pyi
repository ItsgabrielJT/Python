...
class Colorbar:
    ...
    """
    n_rasterize = ...
    def __init__(self, ax, mappable=..., *, cmap=..., norm=..., alpha=..., values=..., boundaries=..., orientation=..., ticklocation=..., extend=..., spacing=..., ticks=..., format=..., drawedges=..., filled=..., extendfrac=..., extendrect=..., label=...) -> None:
        ...
    ...
    def set_ticks(self, ticks, update_ticks=..., labels=..., *, minor=..., **kwargs): # -> None:
        """
        Set tick locations.
    ...
    @_api.delete_parameter("3.5", "update_ticks")
    def set_ticklabels(self, ticklabels, update_ticks=..., *, minor=..., **kwargs): # -> None:
        """
        Set tick labels.
...
def make_axes(parents, location=..., orientation=..., fraction=..., shrink=..., aspect=..., **kw):
    """
...
@docstring.Substitution(_make_axes_param_doc, _make_axes_other_param_doc)
def make_axes_gridspec(parent, *, location=..., orientation=..., fraction=..., shrink=..., aspect=..., **kw): # -> tuple[Unknown, dict[str, Unknown]]:
    """
...
@_api.deprecated("3.4", alternative="Colorbar")
def colorbar_factory(cax, mappable, **kwargs): # -> Colorbar:
    """
