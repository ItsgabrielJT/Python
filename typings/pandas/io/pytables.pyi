...
def to_hdf(path_or_buf, key: str, value: DataFrame | Series, mode: str = ..., complevel: int | None = ..., complib: str | None = ..., append: bool = ..., format: str | None = ..., index: bool = ..., min_itemsize: int | dict[str, int] | None = ..., nan_rep=..., dropna: bool | None = ..., data_columns: Literal[True] | list[str] | None = ..., errors: str = ..., encoding: str = ...) -> None:
    """store this object, close it if we opened it"""
    ...

def read_hdf(path_or_buf, key=..., mode: str = ..., errors: str = ..., where=..., start: int | None = ..., stop: int | None = ..., columns=..., iterator=..., chunksize: int | None = ..., **kwargs): # -> TableIterator:
    """
...
class HDFStore:
    ...
    **kwargs, the HDF5 file is loaded or created in-memory and will only be
    ...
    def __enter__(self): # -> Self@HDFStore:
        ...
    ...
    def select(self, key: str, where=..., start=..., stop=..., columns=..., iterator=..., chunksize=..., auto_close: bool = ...): # -> TableIterator:
        """
    ...
    def select_as_multiple(self, keys, where=..., selector=..., columns=..., start=..., stop=..., iterator=..., chunksize=..., auto_close: bool = ...): # -> TableIterator:
        """
    ...
    def put(self, key: str, value: DataFrame | Series, format=..., index=..., append=..., complib=..., complevel: int | None = ..., min_itemsize: int | dict[str, int] | None = ..., nan_rep=..., data_columns: Literal[True] | list[str] | None = ..., encoding=..., errors: str = ..., track_times: bool = ..., dropna: bool = ...): # -> None:
        """
    ...
    def append(self, key: str, value: DataFrame | Series, format=..., axes=..., index=..., append=..., complib=..., complevel: int | None = ..., columns=..., min_itemsize: int | dict[str, int] | None = ..., nan_rep=..., chunksize=..., expectedrows=..., dropna: bool | None = ..., data_columns: Literal[True] | list[str] | None = ..., encoding=..., errors: str = ...): # -> None:
        """
    ...
    def append_to_multiple(self, d: dict, value, selector, data_columns=..., axes=..., dropna=..., **kwargs): # -> None:
        """
    ...
    def walk(self, where=...): # -> Generator[tuple[Unknown, list[Unknown], list[Unknown]], None, None]:
        """
    ...
    def copy(self, file, mode=..., propindexes: bool = ..., keys=..., complib=..., complevel: int | None = ..., fletcher32: bool = ..., overwrite=...): # -> HDFStore:
        """
...
class TableIterator:
    ...
    def get_result(self, coordinates: bool = ...): # -> Self@TableIterator:
        ...
...
class IndexCol:
    ...
    def convert(self, values: np.ndarray, nan_rep, encoding: str, errors: str): # -> tuple[ndarray[Unknown, Unknown] | DatetimeIndex, ndarray[Unknown, Unknown] | DatetimeIndex]:
        """
...
class GenericIndexCol(IndexCol):
    ...
    def convert(self, values: np.ndarray, nan_rep, encoding: str, errors: str): # -> tuple[ndarray[Unknown, Unknown], ndarray[Unknown, Unknown]]:
        """
        Convert the data from this selection to the appropriate pandas type.
...
class DataCol(IndexCol):
    ...
    is_data_indexable = ...
    _info_fields = ...
    def __init__(self, name: str, values=..., kind=..., typ=..., cname=..., pos=..., tz=..., ordered=..., table=..., meta=..., metadata=..., dtype: DtypeArg | None = ..., data=...) -> None:
        ...
    ...
    def take_data(self): # -> NDArray[Any] | None:
        """return the data"""
        ...
    ...
    @property
    def cvalues(self): # -> NDArray[Any] | None:
        """return my cython values"""
        ...
    ...
    def convert(self, values: np.ndarray, nan_rep, encoding: str, errors: str): # -> tuple[Unknown | None, ndarray[Unknown, Unknown] | DatetimeIndex | NDArray[Any] | Categorical | Unknown]:
        """
        Convert the data from this selection to the appropriate pandas type.
...
class GenericFixed(Fixed):
    ...
    def read_array(self, key: str, start: int | None = ..., stop: int | None = ...): # -> Any | ndarray[Unknown, Unknown] | NDArray[Any] | DatetimeIndex:
    ...
    def write_array(self, key: str, obj: DataFrame | Series, items: Index | None = ...) -> None:
        ...
...
class BlockManagerFixed(GenericFixed):
    ...
    def read(self, where=..., columns=..., start: int | None = ..., stop: int | None = ...): # -> Any | DataFrame:
        ...
...
class Table(Fixed):
    ...
    def index_cols(self): # -> list[tuple[Unknown | None, str]]:
...
class AppendableTable(Table):
    ...
    table_type = ...
    def write(self, obj, axes=..., append=..., complib=..., complevel=..., fletcher32=..., min_itemsize=..., chunksize=..., expectedrows=..., dropna=..., nan_rep=..., data_columns=..., track_times=...): # -> None:
        ...
...
class Selection:
    ...
    def select_coords(self): # -> Any | NDArray[Any] | NDArray[Unknown]:
        """
        generate the selection
        """
        ...
