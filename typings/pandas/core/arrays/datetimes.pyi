...
from pandas.core.arrays import PeriodArray, TimedeltaArray, datetimelike as dtl
from pandas import DataFrame

if TYPE_CHECKING:
    ...
_midnight = ...
def tz_to_dtype(tz): # -> dtype[Unknown] | DatetimeTZDtype:
    """
...
class DatetimeArray(dtl.TimelikeOps, dtl.DatelikeOps):
    ...
    def astype(self, dtype, copy: bool = ...): # -> Self@DatetimeArray | DatetimeArray | PeriodArray | ndarray[Any, dtype[object_]] | ndarray[Any, Unknown] | ExtensionArray | NDArray[Any] | NDArray[int64] | NDArray[Unknown]:
        ...
...
default 'raise'
    ...
    def month_name(self, locale=...): # -> ndarray[Unknown, Unknown]:
        """
    ...
    def day_name(self, locale=...): # -> ndarray[Unknown, Unknown]:
        """
...
def objects_to_datetime64ns(data: np.ndarray, dayfirst, yearfirst, utc=..., errors=..., require_iso8601: bool = ..., allow_object: bool = ..., allow_mixed: bool = ...): # -> tuple[NDArray[Any], tzinfo | None] | tuple[NDArray[Any], tzinfo] | tuple[ndarray[Any, Unknown], None]:
    """
...
def maybe_convert_dtype(data, copy: bool): # -> tuple[Unknown, bool] | tuple[Unknown | NDArray[object_], bool]:
    """
