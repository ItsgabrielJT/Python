...
from pandas._typing import ArrayLike, AstypeArg, Dtype, NpDtype, Ordered, npt
...
class Categorical(NDArrayBackedExtensionArray, PandasObject, ObjectStringArrayMixin):
    ...
    def __init__(self, values, categories=..., ordered=..., dtype: Dtype | None = ..., fastpath: bool = ..., copy: bool = ...) -> None:
        ...
    ...
    @classmethod
    def from_codes(cls, codes, categories=..., ordered=..., dtype: Dtype | None = ...): # -> Self@Categorical:
        """
    ...
    def rename_categories(self, new_categories, inplace=...): # -> Self@Categorical | None:
        """
        Rename categories.
    ...
    def map(self, mapper): # -> Self@Categorical | NDArray[Unknown]:
        """
    ...
    def __array_ufunc__(self, ufunc: np.ufunc, method: str, *inputs, **kwargs): # -> _NotImplementedType | Any:
        ...
    ...
    def argsort(self, ascending=..., kind=..., **kwargs): # -> ndarray[Unknown, Unknown]:
        """
    ...
    def take_nd(self, indexer, allow_fill: bool = ..., fill_value=...): # -> Self@Categorical:
        ...
    
    def __iter__(self): # -> Iterator[Unknown] | Generator[Any, None, None]:
        """
    ...
    def replace(self, to_replace, value, inplace: bool = ...): # -> Self@Categorical | None:
        """
