...
import numpy as np
from typing import Any, Callable, Hashable, Iterable, Sequence, TYPE_CHECKING
from pandas._libs import index as libindex
from pandas._libs.hashtable import duplicated
from pandas._typing import F, Shape, npt
...
class MultiIndex(Index):
    ...
    _comparables = ...
    sortorder: int | None
    def __new__(cls, levels=..., codes=..., sortorder=..., names=..., dtype=..., copy=..., name=..., verify_integrity: bool = ...): # -> Self@MultiIndex:
        ...
    ...
    @classmethod
    @names_compat
    def from_tuples(cls, tuples: Iterable[tuple[Hashable, ...]], sortorder: int | None = ..., names: Sequence[Hashable] | None = ...) -> MultiIndex:
        """
    ...
    def set_levels(self, levels, level=..., inplace=..., verify_integrity: bool = ...): # -> Self@MultiIndex | MultiIndex | None:
        """
    ...
    def set_codes(self, codes, level=..., inplace=..., verify_integrity: bool = ...): # -> Self@MultiIndex | MultiIndex | None:
        """
    ...
    def duplicated(self, keep=...) -> npt.NDArray[np.bool_]:
        ...
    ...
    @doc(Index.unique)
    def unique(self, level=...): # -> MultiIndex | Index:
        ...
    ...
    def __reduce__(self): # -> tuple[(cls: Unknown, d: Unknown) -> Unknown, tuple[Type[Self@MultiIndex], dict[str, Unknown]], None]:
    ...
    def take(self: MultiIndex, indices, axis: int = ..., allow_fill: bool = ..., fill_value=..., **kwargs) -> MultiIndex:
        ...
    ...
    def sortlevel(self, level=..., ascending: bool = ..., sort_remaining: bool = ...) -> tuple[MultiIndex, npt.NDArray[np.intp]]:
        """
    ...
    def get_slice_bound(self, label: Hashable | Sequence[Hashable], side: str, kind=...) -> int:
        """
    ...
    def get_loc_level(self, key, level=..., drop_level: bool = ...): # -> tuple[NDArray[Any] | Unknown | NDArray[bool_] | NDArray[Unknown] | slice | Any | int | ndarray[Unknown, Unknown] | None, Unknown | None]:
        """
    ...
    @doc(Index.astype)
    def astype(self, dtype, copy: bool = ...): # -> MultiIndex | Self@MultiIndex:
        ...
...
def sparsify_labels(label_list, start: int = ..., sentinel=...): # -> list[tuple[Unknown]]:
    ...
