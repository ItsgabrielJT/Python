...
from typing import Callable, ContextManager, Counter, Iterable, TYPE_CHECKING
from pandas._config.localization import can_set_locale, get_locales, set_locale
from pandas._typing import Dtype
from pandas.core.dtypes.common import is_float_dtype, is_integer_dtype, is_sequence, is_unsigned_integer_dtype, pandas_dtype
from pandas import Categorical, CategoricalIndex, DataFrame, DatetimeIndex, Index, IntervalIndex, MultiIndex, PeriodIndex, RangeIndex, Series, TimedeltaIndex, bdate_range
from pandas._testing._io import close, network, round_trip_localpath, round_trip_pathlib, round_trip_pickle, with_connectivity_check, write_to_compressed
...
from pandas._testing.contexts import RNGContext, decompress_file, ensure_clean, ensure_clean_dir, ensure_safe_environment_variables, set_timezone, use_numexpr, with_csv_dialect
from pandas.core.api import Float64Index, Int64Index, NumericIndex, UInt64Index
from pandas.core.arrays import BaseMaskedArray, ExtensionArray, PandasArray
...
def to_array(obj): # -> ArrayLike | NDArray[Unknown] | Any:
    """
...
def makeStringIndex(k=..., name=...): # -> Index:
    ...

def makeUnicodeIndex(k=..., name=...): # -> Index:
    ...
...
def makeBoolIndex(k=..., name=...): # -> Index:
    ...

def makeNumericIndex(k=..., name=..., *, dtype): # -> NumericIndex:
    ...

def makeIntIndex(k=..., name=...): # -> Int64Index:
    ...

def makeUIntIndex(k=..., name=...): # -> UInt64Index:
    ...

def makeRangeIndex(k=..., name=..., **kwargs): # -> RangeIndex:
    ...

def makeFloatIndex(k=..., name=...): # -> Float64Index:
    ...
...
def makeMultiIndex(k=..., names=..., **kwargs): # -> MultiIndex:
    ...

_names = ...
def index_subclass_makers_generator(): # -> Generator[Unknown, None, None]:
    ...
...
def makeFloatSeries(name=...): # -> Series:
    ...

def makeStringSeries(name=...): # -> Series:
    ...

def makeObjectSeries(name=...): # -> Series:
    ...

def getSeriesData(): # -> dict[str, Series]:
    ...

def makeTimeSeries(nper=..., freq=..., name=...): # -> Series:
    ...

def makePeriodSeries(nper=..., name=...): # -> Series:
    ...

def getTimeSeriesData(nper=..., freq=...): # -> dict[str, Series]:
    ...

def getPeriodData(nper=...): # -> dict[str, Series]:
    ...

def makeTimeDataFrame(nper=..., freq=...): # -> DataFrame:
    ...

def makeDataFrame() -> DataFrame:
    ...

def getMixedTypeDict(): # -> tuple[Index, dict[str, Unknown]]:
    ...

def makeMixedDataFrame(): # -> DataFrame:
    ...

def makePeriodFrame(nper=...): # -> DataFrame:
    ...
...
def makeCustomDataframe(nrows, ncols, c_idx_names=..., r_idx_names=..., c_idx_nlevels=..., r_idx_nlevels=..., data_gen_f=..., c_ndupe_l=..., r_ndupe_l=..., dtype=..., c_idx_type=..., r_idx_type=...): # -> DataFrame:
    """
...
def makeMissingDataframe(density=..., random_state=...): # -> DataFrame:
    ...

def test_parallel(num_threads=..., kwargs_list=...): # -> (func: Unknown) -> ((*args: Unknown, **kwargs: Unknown) -> None):
    """
