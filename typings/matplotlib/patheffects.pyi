...
class PathEffectRenderer(RendererBase):
    ...
    def copy_with_path_effect(self, path_effects): # -> Self@PathEffectRenderer:
        ...
    
    def draw_path(self, gc, tpath, affine, rgbFace=...): # -> None:
        ...
    
    def draw_markers(self, gc, marker_path, marker_trans, path, *args, **kwargs): # -> None:
        ...
    
    def draw_path_collection(self, gc, master_transform, paths, *args, **kwargs): # -> None:
        ...
...
class SimplePatchShadow(AbstractPathEffect):
    ...
    def __init__(self, offset=..., shadow_rgbFace=..., alpha=..., rho=..., **kwargs) -> None:
        """
        Parameters
        ----------
...
class SimpleLineShadow(AbstractPathEffect):
    ...
    def __init__(self, offset=..., shadow_color=..., alpha=..., rho=..., **kwargs) -> None:
        """
        Parameters
        ----------
        offset : (float, float), default: (2, -2)
...
class TickedStroke(AbstractPathEffect):
    ...
    """
    def __init__(self, offset=..., spacing=..., angle=..., length=..., **kwargs) -> None:
        """
        Parameters
        ----------
        offset : (float, float), default: (0, 0)
