...
class Colormap:
    ...
    def __copy__(self): # -> Self@Colormap:
        ...
    ...
    def with_extremes(self, *, bad=..., under=..., over=...): # -> Self@Colormap:
        """
