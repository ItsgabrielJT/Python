...
import numpy as np
from typing import Callable, Generic, Hashable, Iterator, Sequence, final
...
class WrappedCythonOp:
    ...
    _cython_arity = ...
    def get_cython_func_and_vals(self, values: np.ndarray, is_numeric: bool): # -> tuple[Any, NDArray[float64]] | tuple[Any | None, NDArray[float64] | ndarray[Unknown, Unknown]]:
        """
...
class BinGrouper(BaseGrouper):
    ...
    def get_iterator(self, data: NDFrame, axis: int = ...): # -> Generator[tuple[Any, Unknown] | tuple[Unknown, Unknown], None, None]:
        """
        Groupby iterator
