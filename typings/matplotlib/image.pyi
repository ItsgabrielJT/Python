...
class AxesImage(_ImageBase):
    ...
    **kwargs : `.Artist` properties
    ...
    def get_extent(self): # -> tuple[float, Unknown, Unknown, float] | tuple[float, Unknown, float, Unknown]:
...
class PcolorImage(AxesImage):
    ...
    def make_image(self, renderer, magnification=..., unsampled=...): # -> tuple[Unknown, Unknown, Unknown, IdentityTransform]:
        ...
...
def imsave(fname, arr, vmin=..., vmax=..., cmap=..., format=..., origin=..., dpi=..., *, metadata=..., pil_kwargs=...):
    """
...
def thumbnail(infile, thumbfile, scale=..., interpolation=..., preview=...): # -> Figure:
    """
