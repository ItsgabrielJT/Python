...
import numpy as np
from typing import Any, Callable, Hashable, TYPE_CHECKING, TypeVar
...
class BaseArrayManager(DataManager):
    ...
    def __getstate__(self): # -> tuple[list[ndarray[Unknown, Unknown] | ExtensionArray], list[Index]]:
        ...
    ...
    def putmask(self, mask, new, align: bool = ...): # -> Self@BaseArrayManager:
        ...
    ...
    def to_native_types(self, **kwargs): # -> Self@BaseArrayManager:
        ...
    ...
    def reindex_indexer(self: T, new_axis, indexer, axis: int, fill_value=..., allow_dups: bool = ..., copy: bool = ..., consolidate: bool = ..., only_slice: bool = ..., use_na_proxy: bool = ...) -> T:
        ...
...
class ArrayManager(BaseArrayManager):
    ...
    def quantile(self, *, qs: Float64Index, axis: int = ..., transposed: bool = ..., interpolation=...) -> ArrayManager:
        ...
    ...
    def as_array(self, dtype=..., copy: bool = ..., na_value=...) -> np.ndarray:
        """
...
class SingleArrayManager(BaseArrayManager, SingleDataManager):
    ...
    @classmethod
    def from_array(cls, array, index): # -> Self@SingleArrayManager:
        ...
    ...
    def array_values(self): # -> PandasArray | ExtensionArray:
    ...
    def apply(self, func, **kwargs): # -> Self@SingleArrayManager:
        ...
    
    def setitem(self, indexer, value): # -> Self@SingleArrayManager:
        """
