...
class PythonParser(ParserBase):
    ...
    def read(self, rows: int | None = ...): # -> tuple[Index, Sequence[Hashable] | MultiIndex, dict[Unknown, Series]] | tuple[Unknown, Sequence[Hashable], Mapping[Hashable, ArrayLike]]:
        ...
    
    def get_chunk(self, size=...): # -> tuple[Index, Sequence[Hashable] | MultiIndex, dict[Unknown, Series]] | tuple[Unknown, Sequence[Hashable], Mapping[Hashable, ArrayLike]]:
        ...
