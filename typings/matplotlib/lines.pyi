...
@docstring.interpd
@cbook._define_aliases({ "antialiased": ["aa"],"color": ["c"],"drawstyle": ["ds"],"linestyle": ["ls"],"linewidth": ["lw"],"markeredgecolor": ["mec"],"markeredgewidth": ["mew"],"markerfacecolor": ["mfc"],"markerfacecoloralt": ["mfcalt"],"markersize": ["ms"] })
class Line2D(Artist):
    """
    ...
    @_api.deprecated("3.4")
    @_api.classproperty
    def validCap(cls): # -> tuple[Any, ...]:
        ...
    
    @_api.deprecated("3.4")
    @_api.classproperty
    def validJoin(cls): # -> tuple[Any, ...]:
        ...
    
    def __str__(self) -> str:
        ...
    
    def __init__(self, xdata, ydata, linewidth=..., linestyle=..., color=..., marker=..., markersize=..., markeredgewidth=..., markeredgecolor=..., markerfacecolor=..., markerfacecoloralt=..., fillstyle=..., antialiased=..., dash_capstyle=..., solid_capstyle=..., dash_joinstyle=..., solid_joinstyle=..., pickradius=..., drawstyle=..., markevery=..., **kwargs) -> None:
        """
...
(float, float) or list[bool]
    ...
    def get_data(self, orig=...): # -> tuple[NDArray[Any] | Unknown | None, NDArray[Any] | Unknown | None]:
        """
    ...
    def get_xdata(self, orig=...): # -> NDArray[Any] | None:
        """
        Return the xdata.
    ...
    def get_ydata(self, orig=...): # -> NDArray[Any] | None:
        """
        Return the ydata.
